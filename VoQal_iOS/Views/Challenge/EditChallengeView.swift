...
class EditChallengeView: BaseView {
    ...
    func setSongTitleValue(_ songTitle: String) {
        songTitleField.text = songTitle
    }
    
    func setArtistValue(_ artist: String) {
    ...
    func resetThumbnailImageView(_ previousThumbnail: UIImage) {
        self.ThumbnailImageView.image = previousThumbnail
    }
